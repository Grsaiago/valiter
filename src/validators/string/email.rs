...
impl EmailStringValidator {
    ...
    pub fn new() -> Self {
        ...
        Self {
            expression: RegexBuilder::new(
                r"^[a-z0-9_'+\-]+(\.[a-z0-9_'+\-]+)*@([a-z0-9]([a-z0-9\-]*[a-z0-9])?\.)+[a-z]{2,}$",
            )
...
mod test {
    ...
    #[test]
    fn simple_ok() {
        let mut validator = EmailStringValidator::new();
        const VALID_EMAILS: [&str; 27] = [
            "email@domain.com",
        ...
        for email in &VALID_EMAILS {
            ...
            assert_eq!(result, Ok(()), "failed to validate email [{}]", email);
        }
    }
    ...
    fn simple_err() {
        ...
        const INVALID_EMAILS: [&str; 65] = [
            ...
            r"ab(c)d,e:f;g<h>i[j\k]l@example.com",
        ...
        for email in &INVALID_EMAILS {
            ...
            assert_eq!(
                result,
                Err(()),
                "should have not validated email [{}]",
                email
            );
        }
    }
